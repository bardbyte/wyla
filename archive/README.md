> **Archived 2026-09-08.** This is the README of the pre-SAHS platform. Everything it
> describes now lives under `archive/` and nothing in the product imports from it.
> The living repo is described in the root `README.md`.
