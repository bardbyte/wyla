...
def build_graph_map(consensus: dict[str, Any],
    ...
    # a body sits in its HOME well; the wells that merely share it get
    # a tether. Without a steward role the first mapped LOB is the
    ...
    for physical in physicals:
        ...
        map_nodes.append({
            ...
            # the wells that SHARE this body, its home excluded — the
            # rail reads "home GMNS · shared with CFR"
